...
namespace HeatEquationSolverUI
{
	public class MethodBeta
	{
		...
		public static readonly MethodBeta[] Methods = {
			...
			new MethodBeta(BetaCalculator.Osmoip_1_5, "Одношаг. метод неполн. прогноза (1.5)", "osmoip_1_5.PNG"),
			new MethodBeta(BetaCalculator.Osmoip_1_47, "Одношаг. метод неполн. прогноза (1.47)", "osmoip_1_47.PNG"),
			new MethodBeta(BetaCalculator.Osmoip_1_267, "Одношаг. метод неполн. прогноза (1.267)", "osmoip_1_267.PNG"),
			new MethodBeta(BetaCalculator.Osmoip_1_274, "Одношаг. метод неполн. прогноза (1.274)", "osmoip_1_274.PNG"),
			new MethodBeta(BetaCalculator.Osmoip_1_301, "Одношаг. метод неполн. прогноза (1.301)", "osmoip_1_301.PNG") };
	}
}
