...
namespace HeatEquationSolver
{
	...
	public class HeatEquation
	{
		...
		public HeatEquation(Function u, ComplexFunction K, ComplexFunction g, ComplexFunction dK_dy, InitialCondition initCond, BoundaryCondtion leftBoundCond, BoundaryCondtion rightBoundCond)
		{
			this.u = u;
			this.K = K;
			this.g = g;
